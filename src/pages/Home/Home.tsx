  ...
  return (
    <div>
      <div className="App">
        <header className="App-header">
          <div className="headerItens">
            ...
            <div className="buttons">
                  <a href='/register' className="buttonR">Registrar-se</a>

                  <a href='/login'  className="buttonL">Iniciar sessão</a>
        ...
        <img src="https://www.pcdf.df.gov.br/images/PCDF_WALLPAPER_004.png"/>

          <h1 className='titleBox'>
          Quem somos?
          </h1>
          <p className="textBox1">
          Bem-vindo ao Portal da Polícia Civil! Nosso software é a ferramenta essencial para a aplicação da lei e a manutenção da segurança pública. Aqui, você encontrará uma plataforma abrangente e eficiente que permite aos nossos agentes realizar investigações de forma mais eficaz, rastrear criminosos, gerenciar casos e compartilhar informações vitais.
          </p>
